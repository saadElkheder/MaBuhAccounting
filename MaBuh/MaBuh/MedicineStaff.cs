namespace MaBuh
{
    class MedicineStaff
    {
        ...
        public double CalcWorkedYearsSum()
        {
            return 0.2*sum;
        }
        ...
        {
            return CalcWorkedDaysBySum() + CalcBedIll() +
                CalcNightDays() + CalcHolidaySum() +
                CalcWorkedYearsSum() + CalcIntensity();
        }
